...
<style>
  ...
  .hero { padding: 1.25rem; margin-bottom: 1.3rem; border-radius: 1.25rem; color: var(--txt); background: radial-gradient(circle at top left, rgba(16,185,129,.3), transparent 38%), var(--card); border: 1px solid var(--border); }
  .hero span,
