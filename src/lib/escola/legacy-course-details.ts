import type { SchoolCourseDetail } from './catalog';

// Compatibilidade para mini-cursos/rotas antigas que ainda não foram promovidos
// para cursos principais. As páginas devem aceder através de schoolCourseDetailForSlug()
// em catalog.ts para manter uma entrada pública única.
export const legacyCourseDetails: Record<string, SchoolCourseDetail> = {
